...
describe('StringNumber', () => {
    ...
    runTest('String Number In Notation', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        notes1[0]
            .addModifier(f.StringNumber({ number: '5', position: 'right' }, true), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'left' }, true), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'right' }, true), 2);
        notes1[1]
            .addModifier(f.Accidental({ type: '#' }), 0)
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, true), 0)
            .addModifier(f.Accidental({ type: '#' }).setAsCautionary(), 1)
            .addModifier(f
            .StringNumber({ number: '3', position: 'above' }, true)
            .setLastNote(notes1[3])
            .setLineEndType(Renderer.LineEndType.DOWN), 2);
        notes1[2]
            .addModifier(f.StringNumber({ number: '5', position: 'left' }, true), 0)
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, true), 2)
            .addModifier(f.Accidental({ type: '#' }), 1);
        notes1[3]
            .addModifier(f.StringNumber({ number: '5', position: 'right' }, true).setOffsetY(7), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'right' }, true).setOffsetY(6), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'right' }, true).setOffsetY(-6), 2);
        ...
        notes2[1]
            ...
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, true), 0)
            .addModifier(f.Accidental({ type: '#' }), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'above' }, true).setLastNote(notes2[3]).setDashed(false), 2);
        notes2[2]
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, true), 2)
            .addModifier(f.Accidental({ type: '#' }), 1);
        notes2[3]
        ...
        notesBar3[0]
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, true), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'right' }, true), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, true), 2)
            .addModifier(f.StringNumber({ number: '2', position: 'above' }, true), 3);
        const voice3 = score.voice(notesBar3, { time: '6/4' });
        f.Formatter().joinVoices([voice3]).formatToStave([voice3], stave3);
        f.draw();
        yield expectMatchingScreenshot(options, 'stringnumber_tests.test.ts');
        assert.ok(true, 'String Number');
    }));
    runTest('String Number In Notation - no circle', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 775, 200, options);
        const score = f.EasyScore();
        // bar 1
        ...
        const notes1 = score.notes('(c4 e4 g4)/4., (c5 e5 g5)/8, (c4 f4 g4)/4, (c4 f4 g4)/4', { stem: 'down' });
        notes1[0]
            .addModifier(f.StringNumber({ number: '5', position: 'right' }, false), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'left' }, false), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'right' }, false), 2);
        notes1[1]
            .addModifier(f.Accidental({ type: '#' }), 0)
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, false), 0)
            .addModifier(f.Accidental({ type: '#' }).setAsCautionary(), 1)
            .addModifier(f
            .StringNumber({ number: '3', position: 'above' }, false)
            .setLastNote(notes1[3])
            .setLineEndType(Renderer.LineEndType.DOWN), 2);
        notes1[2]
            .addModifier(f.StringNumber({ number: '5', position: 'left' }, false), 0)
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, false), 2)
            .addModifier(f.Accidental({ type: '#' }), 1);
        notes1[3]
            .addModifier(f.StringNumber({ number: '5', position: 'right' }, false).setOffsetY(7), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'right' }, false).setOffsetY(6), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'right' }, false).setOffsetY(-6), 2);
        const voice1 = score.voice(notes1);
        f.Formatter().joinVoices([voice1]).formatToStave([voice1], stave1);
        // bar 2 - juxtaposing second bar next to first bar
        const stave2 = f
        ...
        notes2[1]
            ...
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, false), 0)
            .addModifier(f.Accidental({ type: '#' }), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'above' }, false).setLastNote(notes2[3]).setDashed(false), 2);
        notes2[2]
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, false), 2)
            .addModifier(f.Accidental({ type: '#' }), 1);
        notes2[3]
        ...
        notesBar3[0]
            .addModifier(f.StringNumber({ number: '5', position: 'below' }, false), 0)
            .addModifier(f.StringNumber({ number: '4', position: 'right' }, false), 1)
            .addModifier(f.StringNumber({ number: '3', position: 'left' }, false), 2)
            .addModifier(f.StringNumber({ number: '2', position: 'above' }, false), 3);
        const voice3 = score.voice(notesBar3, { time: '6/4' });
        f.Formatter().joinVoices([voice3]).formatToStave([voice3], stave3);
        f.draw();
        yield expectMatchingScreenshot(options, 'stringnumber_tests.test.ts');
    ...
    runTest('Fret Hand Finger In Notation', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Multi Voice With Strokes, String & Finger Numbers', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Complex Measure With String & Finger Numbers', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Shifted Notehead, Multiple Modifiers', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
