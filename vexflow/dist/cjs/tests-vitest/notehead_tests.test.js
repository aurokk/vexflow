...
describe('NoteHead', () => {
    ...
    runTest('Basic', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'notehead_tests.test.ts');
        assert.ok('Basic NoteHead test');
    }));
    runTest('Various Heads', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes = [
    ...
    runTest('Various Note Heads 1', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes = [
    ...
    runTest('Various Note Heads 2', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes = [
    ...
    runTest('Drum Chord Heads', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes = [
    ...
    runTest('Bounding Boxes', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 450, 250);
        setContextStyle(ctx);
        // 250 is 450/1.8
