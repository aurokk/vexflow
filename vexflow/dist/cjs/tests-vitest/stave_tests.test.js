...
// MIT License
//
// Basic Stave Tests - Vitest Version
...
describe('Stave', () => {
    ...
    function runTest(testName, testFunc, params = {}, backends = [
    ...
    test('StaveModifiers SortByCategory', () => {
        const assert = createAssert();
        // Initialize fonts for Clef construction
        const originalFontNames = Flow.getMusicFont();
    ...
    runTest('Stave Draw Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 150);
        const stave = new Stave(10, 10, 300);
        stave.setContext(ctx);
        stave.draw();
        yield expectMatchingScreenshot(options, 'stave_tests.test.ts');
    ...
    runTest('Open Stave Draw Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Multiple Stave Barline Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const assert = createAssert();
        assert.ok(true);
    ...
    runTest('Multiple Stave Barline Test (14pt Section)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
        ...
        staveBar1.setBegBarType(BarlineType.REPEAT_BEGIN);
        staveBar1.setEndBarType(BarlineType.DOUBLE);
        staveBar1.setSection('A', 0, 0, (_c = options.params) === null || _c === void 0 ? void 0 : _c.fontSize, false);
        staveBar1.addClef('treble').setContext(ctx).draw();
        const notesBar1 = [
            new StaveNote({ keys: ['c/4'], duration: 'q' }),
            new StaveNote({ keys: ['d/4'], duration: 'q' }),
        ...
        // bar 2 - juxtaposing second bar next to first bar
        const staveBar2 = new Stave(staveBar1.getWidth() + staveBar1.getX(), staveBar1.getY(), 300);
        staveBar2.setSection('B', 0, 0, (_d = options.params) === null || _d === void 0 ? void 0 : _d.fontSize);
        staveBar2.setEndBarType(BarlineType.END);
        staveBar2.setContext(ctx).draw();
        const notesBar2_part1 = [
            new StaveNote({ keys: ['c/4'], duration: '8' }),
    ...
    runTest('Multiple Stave Repeats Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
    ...
    runTest('Stave End Modifiers Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
    ...
    runTest('Stave Repetition (CODA) Positioning', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
    ...
    runTest('Stave Repetition (CODA) Positioning (-20)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
        const ctx = contextBuilder(options.elementId, 725, 200);
    ...
    runTest('Stave Repetition (CODA) Positioning (+10)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
        const ctx = contextBuilder(options.elementId, 725, 200);
    ...
    runTest('Multiple Staves Volta Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
        const ctx = contextBuilder(options.elementId, 725, 200);
    ...
    runTest('Volta + Modifier Measure Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
        // Get the rendering context
    ...
    runTest('Tempo Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        assert.ok(true);
    ...
    runTest('Single Line Configuration Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        assert.equal(config[2].visible, true, 'getLinesConfiguration() - Line 2');
        assert.equal(config[3].visible, false, 'getLinesConfiguration() - Line 3');
        assert.equal(config[4].visible, true, 'getLinesConfiguration() - Line 4');
        assert.ok(true, 'all pass');
    }));
    runTest('Batch Line Configuration Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
        const stave = new Stave(10, 10, 300);
        stave
        ...
        assert.equal(config[1].visible, true, 'getLinesConfiguration() - Line 1');
        assert.equal(config[2].visible, false, 'getLinesConfiguration() - Line 2');
        assert.equal(config[3].visible, true, 'getLinesConfiguration() - Line 3');
        assert.equal(config[4].visible, false, 'getLinesConfiguration() - Line 4');
        assert.ok(true, 'all pass');
    }));
    runTest('Stave Text Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Multiple Line Stave Text Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Factory API', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
