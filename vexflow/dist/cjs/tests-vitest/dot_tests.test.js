...
import { createAssert, expectMatchingScreenshot, FONT_STACKS, generateTestID, plotLegendForNoteWidth, } from './vitest_test_helpers';
/**
...
describe('Dot', () => {
    ...
    runTest('Basic', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'dot_tests.test.ts');
