 ...
 */
function setupContext(contextBuilder, elementId, width = 350, height = 150) {
...
describe('Rests', () => {
     ...
     */
    runTest('Outside Stave', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        yield expectMatchingScreenshot(options, 'rests_tests.test.ts');
     ...
     */
    runTest('Dotted', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 700);
        const notes = [
     ...
     */
    runTest('Auto Align - Beamed Notes Stems Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
     ...
     */
    runTest('Auto Align - Beamed Notes Stems Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 600, 160);
        const notes = [
     ...
     */
    runTest('Auto Align - Tuplets Stems Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 600, 160);
        const notes = [
     ...
     */
    runTest('Auto Align - Tuplets Stems Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 600, 160);
        const notes = [
     ...
     */
    runTest('Auto Align - Single Voice (Default)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 600, 160);
        const notes = [
            note({ keys: ['b/4'], stem_direction: -1, duration: '4r' }),
     ...
     */
    runTest('Auto Align - Single Voice (Align All)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const { context, stave } = setupContext(contextBuilder, options.elementId, 600, 160);
        const notes = [
            note({ keys: ['b/4'], stem_direction: -1, duration: '4r' }),
     ...
     */
    runTest('Auto Align - Multi Voice', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
