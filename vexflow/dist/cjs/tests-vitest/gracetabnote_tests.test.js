...
describe('Grace Tab Notes', () => {
    ...
    runTest('Grace Tab Note Simple', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        yield expectMatchingScreenshot(options, 'gracetabnote_tests.test.ts');
        assert.ok(true, 'Simple Test');
    }));
    runTest('Grace Tab Note Slurred', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const context = contextBuilder(options.elementId, 350, 140);
        const stave = new TabStave(10, 10, 350).addTabGlyph().setContext(context).draw();
