...
describe('Bend', () => {
    ...
    runTest('Double Bends', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'bend_tests.test.ts');
        assert.ok(true, 'Double Bends');
    }));
    runTest('Reverse Bends', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const renderer = new Renderer(options.elementId, options.backend);
        renderer.resize(500, 240);
        const ctx = renderer.getContext();
    ...
    runTest('Bend Phrase', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const renderer = new Renderer(options.elementId, options.backend);
        renderer.resize(500, 240);
        const ctx = renderer.getContext();
    ...
    runTest('Double Bends With Release', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const renderer = new Renderer(options.elementId, options.backend);
    ...
    runTest('Whako Bend', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const renderer = new Renderer(options.elementId, options.backend);
