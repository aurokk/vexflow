...
describe('Articulation', () => {
    ...
    function runTestWithParams(testName, testFunc, params, backends = [
        { backend: Renderer.Backends.CANVAS, fontStacks: ['Bravura'] },
        { backend: Renderer.Backends.SVG, fontStacks: ['Bravura', 'Gonville', 'Petaluma', 'Leland'] },
    ]) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    runTest('Articulation - Vertical Placement', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'articulation_tests.test.ts');
        assert.ok(true, ' Annotation Placement');
    }));
    runTest('Articulation - Vertical Placement (Glyph codes)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 750, 300);
        const staveNote = (noteStruct) => new StaveNote(noteStruct);
        const stave = new Stave(10, 50, 750).addClef('treble').setContext(ctx).draw();
    ...
    runTestWithParams('Articulation - Staccato/Staccatissimo', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTestWithParams('Articulation - Accent/Tenuto', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const width = 125 - Stave.defaultPadding;
    ...
    runTestWithParams('Articulation - Marcato/L.H. Pizzicato', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const width = 125 - Stave.defaultPadding;
    ...
    runTestWithParams('Articulation - Snap Pizzicato/Fermata', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const width = 125 - Stave.defaultPadding;
    ...
    runTestWithParams('Articulation - Up-stroke/Down-Stroke', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const width = 125 - Stave.defaultPadding;
    ...
    runTestWithParams('Articulation - Fermata Above/Below', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
    ...
    runTestWithParams('Articulation - Fermata Short Above/Below', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const f = makeFactory(options.backend, options.elementId, 400, 195, options);
    ...
    runTestWithParams('Articulation - Fermata Long Above/Below', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const f = makeFactory(options.backend, options.elementId, 400, 195, options);
    ...
    runTestWithParams('Articulation - Fermata Very Long Above/Below', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const sym1 = options.params.sym1;
        const sym2 = options.params.sym2;
        const f = makeFactory(options.backend, options.elementId, 400, 195, options);
    ...
    runTestWithParams('Articulation - Inline/Multiple', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const scale = 0.8;
    ...
    runTestWithParams('TabNote Articulation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
