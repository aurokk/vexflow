...
describe('Style', () => {
    ...
    runTest('Basic Style', (options) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'style_tests.test.ts');
        assert.ok(true, 'Basic Style');
    }));
    runTest('TabNote modifiers Style', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
