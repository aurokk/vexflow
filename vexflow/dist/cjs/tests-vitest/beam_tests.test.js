...
import { AnnotationVerticalJustify, Beam, Dot, Factory, Font, FontStyle, FontWeight, Stem, Voice, } from '../src/index';
...
describe('Beam', () => {
    ...
    runTest('Simple Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'beam_tests.test.ts');
        assert.ok(true, 'Simple Test');
    }));
    runTest('Multi Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 140 } });
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Sixteenth Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 140 } });
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Slopey Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Auto-stemmed Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 350, height: 140 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('Mixed Beam 1', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 350, height: 140 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('Mixed Beam 2', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Dotted Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 140 } });
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Partial Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 140 } });
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Close Trade-offs Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 140 } });
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Insane Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 180 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('Lengthy Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 180 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('Outlier Beam', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 450, height: 180 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('Break Secondary Beams', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Partial Beam Direction', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 600, height: 200 } });
        const stave = f.Stave({ y: 20 });
        const score = f.EasyScore();
    ...
    runTest('TabNote Beams Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 600, height: 200 } });
    ...
    runTest('TabNote Beams Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('TabNote Auto Create Beams', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 600, height: 200 } });
    ...
    runTest('TabNote Beams Auto Stem', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Complex Beams with Annotations', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Complex Beams with Articulations', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Complex Beams with Articulations two Staves', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
