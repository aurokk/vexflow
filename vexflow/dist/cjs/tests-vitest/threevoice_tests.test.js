...
import { concat, createAssert, expectMatchingScreenshot, FONT_STACKS, generateTestID, makeFactory } from './vitest_test_helpers';
describe('Three Voice Rests', () => {
    ...
    function createThreeVoicesTest(noteGroup1, noteGroup2, noteGroup3, setup) {
        return (options, contextBuilder) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield expectMatchingScreenshot(options, 'threevoice_tests.test.ts');
            assert.ok(true);
        });
    }
    runTest('Three Voices - #1', createThreeVoicesTest(['e5/2, e5', { stem: 'up' }], ['(d4 a4 d#5)/8, b4, (d4 a4 c5), b4, (d4 a4 c5), b4, (d4 a4 c5), b4', { stem: 'down' }], ['b3/4, e3, f3, a3', { stem: 'down' }], (f, voices) => {
    ...
    runTest('Three Voices - #2 Complex', createThreeVoicesTest(['(a4 e5)/16, e5, e5, e5, e5/8, e5, e5/2', { stem: 'up' }], ['(d4 d#5)/16, (b4 c5), d5, e5, (d4 a4 c5)/8, b4, (d4 a4 c5), b4, (d4 a4 c5), b4', { stem: 'down' }], ['b3/8, b3, e3/4, f3, a3', { stem: 'down' }], (f, voices) => {
        voices[0]
            .getTickables()[0]
    ...
    runTest('Three Voices - #3', createThreeVoicesTest(['(g4 e5)/4, e5, (g4 e5)/2', { stem: 'up' }], ['c#5/4, b4/8, b4/8/r, a4/4., g4/8', { stem: 'down' }], ['c4/4, b3, a3, g3', { stem: 'down' }], (f, voices) => {
        voices[0]
            .getTickables()[0]
            .addModifier(f.Fingering({ number: '0', position: 'left' }), 0)
    ...
    runTest('Auto Adjust Rest Positions - Two Voices', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Auto Adjust Rest Positions - Three Voices #1', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Auto Adjust Rest Positions - Three Voices #2', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 850, 200, options);
        const score = f.EasyScore();
        let x = 10;
