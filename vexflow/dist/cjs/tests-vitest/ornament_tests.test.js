...
describe('Ornament', () => {
    ...
    runTest('Ornaments', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'ornament_tests.test.ts');
        assert.ok(true);
    }));
    runTest('Ornaments Vertically Shifted', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 750, 195);
        const stave = new Stave(10, 30, 700);
        stave.setContext(ctx).draw();
    ...
    runTest('Ornaments - Delayed turns', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Ornaments - Delayed turns, Multiple Draws', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 550, 195, options);
        const { context, stave, notes } = addDelayedTurns(f);
    ...
    runTest('Ornaments - Delayed turns, Multiple Voices', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Stacked', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 550, 195, options);
    ...
    runTest('With Upper/Lower Accidentals', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Jazz Ornaments', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
