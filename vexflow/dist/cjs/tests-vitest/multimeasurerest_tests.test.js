...
describe('MultiMeasureRest', () => {
    ...
    runTest('Simple Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        context.restore();
        yield expectMatchingScreenshot(options, 'multimeasurerest_tests.test.ts');
        assert.ok(true, 'Simple Test');
    }));
    runTest('Stave with modifiers Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const width = 910;
