...
describe('Clef', () => {
    ...
    runTest('Clef Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const f = new Factory({
        ...
        f.Stave()
            ...
            .addEndClef('treble');
        f.draw();
        yield expectMatchingScreenshot(options, 'clef_tests.test.ts');
        createAssert().ok(true, 'all pass');
    }));
    runTest('Clef End Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const f = new Factory({
            renderer: { elementId: options.elementId, backend: options.backend, width: 800, height: 120 },
        });
        f.Stave()
    ...
    runTest('Small Clef Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const f = new Factory({
            renderer: { elementId: options.elementId, backend: options.backend, width: 800, height: 120 },
        });
        f.Stave()
    ...
    runTest('Small Clef End Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const f = new Factory({
            renderer: { elementId: options.elementId, backend: options.backend, width: 800, height: 120 },
        });
        f.Stave()
    ...
    runTest('Clef Change Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const f = new Factory({
