...
describe('Annotation', () => {
     ...
     */
    runTest('Lyrics', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'annotation_tests.test.ts');
        createAssert().ok(true);
    }));
    runTest('Simple Annotation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Standard Notation Annotation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
        ctx.scale(1.5, 1.5);
    ...
    runTest('Styled Annotation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
        ctx.scale(1.5, 1.5);
        const stave = new Stave(10, 10, 450).addClef('treble').setContext(ctx).draw();
    ...
    runTest('Harmonics', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
        ctx.scale(1.5, 1.5);
        ctx.font = '10pt Arial';
        const stave = new TabStave(10, 10, 450).addTabGlyph().setContext(ctx).draw();
    ...
    runTest('Fingerpicking', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
    ...
    runTest('Placement', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Bottom Annotation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
        ctx.scale(1.5, 1.5);
    ...
    runTest('Bottom Annotations with Beams', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 500, 240);
        ctx.scale(1.5, 1.5);
        const stave = new Stave(10, 10, 300).addClef('treble').setContext(ctx).draw();
        const notes = [
    ...
    runTest('Test Justification Annotation Stem Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Test Justification Annotation Stem Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('TabNote Annotations', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
