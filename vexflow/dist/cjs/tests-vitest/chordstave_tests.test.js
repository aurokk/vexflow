...
describe('ChordStave', () => {
    ...
    runTest('ChordStave Draw Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const ctx = contextBuilder(options.elementId, 400, 160);
        const stave = new ChordStave(10, 10, 300);
        stave.setContext(ctx);
        stave.draw();
        yield expectMatchingScreenshot(options, 'chordstave_tests.test.ts');
    ...
    runTest('ChordStave with Time Signature', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Multiple ChordStaves (4x4 Grid)', (options) => __awaiter(void 0, void 0, void 0, function* () {
