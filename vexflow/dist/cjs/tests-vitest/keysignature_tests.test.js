...
import { createAssert, expectMatchingScreenshot, FONT_STACKS, generateTestID, MAJOR_KEYS, makeFactory, MINOR_KEYS } from './vitest_test_helpers';
const fontWidths = () => {
...
describe('KeySignature', () => {
    ...
    runTest('Major Key Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const w = fontWidths();
        ...
        stave2.draw();
        yield expectMatchingScreenshot(options, 'keysignature_tests.test.ts');
        assert.ok(true, 'all pass');
    }));
    runTest('Minor Key Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const accidentalCount = 28; // total number in all the keys
        const w = fontWidths();
        const casePadding = 10; // hard-coded in staveModifier
    ...
    runTest('Stave Helper', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const w = fontWidths();
        const accidentalCount = 28; // total number in all the keys
        const casePadding = 10; // hard-coded in staveModifier
    ...
    runTest('Cancelled key test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const scale = 0.9;
        const w = fontWidths();
    ...
    runTest('Cancelled key (for each clef) test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const scale = 0.8;
        const w = fontWidths();
        const keyPadding = 10;
    ...
    runTest('Altered key test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('End key with clef test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Key Signature Change test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Key Signature with/without clef symbol', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 900, undefined, options);
