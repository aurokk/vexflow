...
describe('StaveNote', () => {
    ...
    runTest('StaveNote Draw - Treble', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const clef = 'treble';
        const octaveShift = 0;
        const restKey = 'r/4';
        ...
        yield expectMatchingScreenshot(options, 'stavenote_tests.test.ts');
    }));
    runTest('StaveNote BoundingBoxes - Treble', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const clef = 'treble';
        const octaveShift = 0;
        const restKey = 'r/4';
    ...
    runTest('StaveNote Draw - Alto', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const clef = 'alto';
        const octaveShift = -1;
        const restKey = 'r/4';
    ...
    runTest('StaveNote Draw - Tenor', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const clef = 'tenor';
        const octaveShift = -1;
        const restKey = 'r/3';
    ...
    runTest('StaveNote Draw - Bass', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const clef = 'bass';
        const octaveShift = -2;
        const restKey = 'r/3';
    ...
    runTest('StaveNote Draw - Harmonic And Muted', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote Draw - Slash', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 700, 180);
    ...
    runTest('Displacements', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote Draw - Bass 2', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote Draw - Key Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote Draw - StaveNote Stem Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 300, 280);
        const stave = new Stave(10, 0, 100);
        ctx.scale(3, 3);
    ...
    runTest('StaveNote Draw - StaveNote Stem Lengths', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote Draw - StaveNote Flag Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 300, 280);
        const stave = new Stave(10, 0, 100);
        ctx.scale(3, 3);
    ...
    runTest('StaveNote Draw - StaveNote Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 300, 280);
        const stave = new Stave(10, 0, 100);
        ctx.scale(3, 3);
    ...
    runTest('Stave, Ledger Line, Beam, Stem and Flag Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Flag and Dot Placement - Stem Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Flag and Dots Placement - Stem Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Beam and Dot Placement - Stem Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 150);
        ctx.scale(1.0, 1.0);
        const stave = new Stave(10, 10, 975);
    ...
    runTest('Beam and Dot Placement - Stem Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 160);
        ctx.scale(1.0, 1.0);
        const stave = new Stave(10, 10, 975);
    ...
    runTest('No Padding', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Note Heads Placement - Simple', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Note Heads Placement - Hidden Notes', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const vf = makeFactory(options.backend, options.elementId, 800, 250, options);
        const score = vf.EasyScore();
        const system1 = vf.System({ y: 100, x: 50, width: 200 });
    ...
    runTest('Center Aligned Note', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Center Aligned Note with Articulation', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 400, 160, options);
        const stave = f.Stave({ x: 10, y: 10, width: 350 }).addClef('treble').addTimeSignature('4/4');
        const note = f
    ...
    runTest('Center Aligned Note with Annotation', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 400, 160, options);
        const stave = f.Stave({ x: 10, y: 10, width: 350 }).addClef('treble').addTimeSignature('4/4');
        const note = f
    ...
    runTest('Center Aligned Note - Multi Voice', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 400, 160, options);
    ...
    runTest('Center Aligned Note with Multiple Modifiers', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 400, 160, options);
        const stave = f.Stave({ x: 10, y: 10, width: 350 }).addClef('treble').addTimeSignature('4/4');
