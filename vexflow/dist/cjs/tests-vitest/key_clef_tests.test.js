...
import { createAssert, expectMatchingScreenshot, FONT_STACKS, generateTestID, MAJOR_KEYS, MINOR_KEYS } from './vitest_test_helpers';
const fontWidths = () => {
...
describe('Clef Keys', () => {
    ...
    runTest('Major Key Clef Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'key_clef_tests.test.ts');
        assert.ok(true, 'all pass');
    }));
    runTest('Minor Key Clef Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const w = fontWidths();
        const accidentalCount = 28; // total number in all the keys
        const sharpTestWidth = accidentalCount * w.sharpWidth + w.clefWidth + Stave.defaultPadding + 6 * w.ksPadding;
