...
describe('Tuplet', () => {
    ...
    runTest('Simple Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'tuplet_tests.test.ts');
        assert.ok(true, 'Simple Test');
    }));
    runTest('Beamed Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
    ...
    runTest('Ratioed Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
    ...
    runTest('Bottom Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Bottom Ratioed Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 350, 160, options);
    ...
    runTest('Awkward Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Complex Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Mixed Stem Direction Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ x: 10, y: 10 });
        const notes = [
    ...
    runTest('Mixed Stem Direction Bottom Tuplet', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ x: 10, y: 10 });
        const notes = [
    ...
    runTest('Nested Tuplets', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ x: 10, y: 10 }).addTimeSignature('4/4');
        const notes = [
    ...
    runTest('Single Tuplets', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ x: 10, y: 10 }).addTimeSignature('4/4');
        const notes = [
