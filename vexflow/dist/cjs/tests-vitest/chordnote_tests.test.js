...
describe('ChordNote', () => {
    ...
    runTest('ChordNote - Basic Rendering', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'chordnote_tests.test.ts');
        createAssert().ok(true, 'ChordNote renders successfully');
    }));
    runTest('ChordNote - Multiple Chords', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const f = makeFactory(options.backend, options.elementId, 600, 200, options);
        const stave = f.ChordStave({ x: 10, y: 40, width: 500 });
    ...
    runTest('ChordNote - Different Positions', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('ChordNote - Complex Chords', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('ChordNote - Over Bar Notation', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const f = makeFactory(options.backend, options.elementId, 600, 200, options);
        const stave = f.ChordStave({ x: 10, y: 40, width: 500 });
