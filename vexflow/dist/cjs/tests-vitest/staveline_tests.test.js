...
describe('StaveLine', () => {
    ...
    runTest('Simple StaveLine', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'staveline_tests.test.ts');
        assert.ok(true);
    }));
    runTest('StaveLine Arrow Options', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
