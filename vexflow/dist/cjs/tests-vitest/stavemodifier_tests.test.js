...
describe('StaveModifier', () => {
    ...
    runTest('Stave Draw Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'stavemodifier_tests.test.ts');
        assert.ok(true, 'all pass');
    }));
    runTest('Begin & End StaveModifier Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
