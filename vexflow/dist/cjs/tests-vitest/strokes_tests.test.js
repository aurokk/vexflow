...
describe('Strokes', () => {
    ...
    runTest('Strokes - Brush/Roll/Rasquedo', (options) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'strokes_tests.test.ts');
        assert.ok(true, 'Brush/Roll/Rasquedo');
    }));
    runTest('Strokes - Arpeggio directionless (without arrows)', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Strokes - Multi Voice', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Strokes - Notation and Tab', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Strokes - Multi-Voice Notation and Tab', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
