...
describe('Font', () => {
    ...
    test('setFont', () => {
        ...
        // Create a CanvasContext and call setFont on it.
    ...
    runTest('Set Text Font to Georgia', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        factory.draw();
        yield expectMatchingScreenshot(options, 'font_tests.test.ts');
        // Restore the previous default, or else it will affect the rest of the tests.
        TextNote.TEXT_FONT = defaultFont;
        assert.ok(true);
    }));
    runTest('Set Music Font to Petaluma', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
