...
import { BarlineType, Factory, Registry } from '../src/index';
...
describe('Bach Demo', () => {
    runTest('Minuet 1', (options) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const f = new Factory({ renderer: { elementId: options.elementId, backend: options.backend, width: 1100, height: 900 } });
        ...
        /* Done */
        f.draw();
        yield expectMatchingScreenshot(options, 'bach_tests.test.ts');
