...
describe('Auto-Beaming', () => {
    ...
    runTest('Simple Auto Beaming', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'auto_beam_formatting_tests.test.ts');
        assert.ok(true, 'Auto Beaming Applicator Test');
    }));
    runTest('Auto Beaming With Overflow Group', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Even Group Stem Directions', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Odd Group Stem Directions', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Odd Beam Groups Auto Beaming', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('More Simple Auto Beaming 0', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('More Simple Auto Beaming 1', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Beam Across All Rests', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Beam Across All Rests with Stemlets', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Break Beams on Middle Rests Only', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Break Beams on Rest', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Maintain Stem Directions', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Maintain Stem Directions - Beam Over Rests', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Beat group with unbeamable note - 2/2', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
    ...
    runTest('Offset beat grouping - 6/8 ', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
    ...
    runTest('Odd Time - Guessing Default Beam Groups', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Custom Beam Groups', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 400, options);
        const score = f.EasyScore();
        const stave1 = f.Stave({ y: 10 }).addTimeSignature('5/4');
    ...
    runTest('Simple Tuplet Auto Beaming', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('More Simple Tuplet Auto Beaming', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('More Automatic Beaming', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Automatic Beaming 4/4 with  3, 3, 2 Pattern', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Automatic Beaming 4/4 with  3, 3, 2 Pattern and Overflow', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Automatic Beaming 8/4 with  3, 2, 3 Pattern and 2 Overflows', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Automatic Beaming 8/4 with  3, 2, 3 Pattern and 3 Overflows', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Duration-Based Secondary Beam Breaks', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Duration-Based Secondary Beam Breaks 2', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave();
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Up', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
    ...
    runTest('Flat Beams Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Mixed Direction', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Up (uniform)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Down (uniform)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Up Bounds', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 140, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Flat Beams Down Bounds', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 450, 200, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
