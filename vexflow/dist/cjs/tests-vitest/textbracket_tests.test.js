...
describe('TextBracket', () => {
    ...
    runTest('Simple TextBracket', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'textbracket_tests.test.ts');
        assert.ok(true);
    }));
    runTest('TextBracket Styles', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 550, undefined, options);
        const stave = f.Stave();
        const score = f.EasyScore();
