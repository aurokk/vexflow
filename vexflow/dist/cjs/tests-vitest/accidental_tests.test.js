...
describe('Accidental', () => {
    ...
    runTest('Accidental Padding', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'accidental_tests.test.ts');
        // PlotLegendForNoteWidth not available in Vitest helpers yet
        createAssert().ok(true);
    }));
    runTest('Basic', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Cautionary Accidental', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const staveCount = 12;
        const scale = 0.85;
    ...
    runTest('Accidental Arrangement Special Cases', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 240, options);
        const accid = makeNewAccid(f);
        f.Stave({ x: 10, y: 10, width: 550 });
    ...
    runTest('Stem Down', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 240, options);
        const accid = makeNewAccid(f);
        f.Stave({ x: 10, y: 10, width: 550 });
    ...
    runTest('Multi Voice', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Microtonal', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 240, options);
        const accid = makeNewAccid(f);
        const ctx = f.getContext();
    ...
    runTest('Microtonal (Iranian)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 240, options);
        const accid = makeNewAccid(f);
        const ctx = f.getContext();
    ...
    runTest('Sagittal', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 240, options);
        const accid = makeNewAccid(f);
        const ctx = f.getContext();
    ...
    runTest('Automatic Accidentals', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Automatic Accidentals - C major scale in Ab', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Automatic Accidentals - No Accidentals Necessary', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
    ...
    runTest('Automatic Accidentals - No Accidentals Necessary (EasyScore)', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
        const stave = f.Stave().addKeySignature('A');
        const score = f.EasyScore();
    ...
    runTest('Automatic Accidentals - Multi Voice Inline', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
        const stave = f.Stave().addKeySignature('Ab');
        const notes0 = [
    ...
    runTest('Automatic Accidentals - Multi Voice Offset', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
    ...
    runTest('Automatic Accidentals - Key C, Single Octave', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
    ...
    runTest('Automatic Accidentals - Key C, Two Octaves', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 700, 150, options);
        const stave = f.Stave().addKeySignature('C');
        const notes0 = [
