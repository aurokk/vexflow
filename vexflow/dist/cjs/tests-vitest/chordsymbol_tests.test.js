...
describe('ChordSymbol', () => {
    ...
    runTest('Chord Symbol With Modifiers', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        draw(chords, 240);
        yield expectMatchingScreenshot(options, 'chordsymbol_tests.test.ts');
        createAssert().ok(true, 'Font Size Chord Symbol');
    }));
    runTest('Chord Symbol Font Size Tests', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const f = makeFactory(options.backend, options.elementId, 750, 580, options);
        const ctx = f.getContext();
        ctx.scale(1.5, 1.5);
        function draw(chords, y) {
    ...
    runTest('Chord Symbol Kerning Tests', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Top Chord Symbols', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const f = makeFactory(options.backend, options.elementId, 650 * 1.5, 650, options);
        const ctx = f.getContext();
        ctx.scale(1.5, 1.5);
        // Helper function for creating StaveNotes.
    ...
    runTest('Top Chord Symbols Justified', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Bottom Chord Symbols', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Bottom Stem Down Chord Symbols', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    runTest('Double Bottom Chord Symbols', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
