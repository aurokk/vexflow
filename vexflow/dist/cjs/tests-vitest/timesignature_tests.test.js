...
describe('TimeSignature', () => {
    ...
    runTest('Basic Time Signatures', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        new Stave(10, 10, 500)
            ...
            .setContext(ctx)
            .draw();
        yield expectMatchingScreenshot(options, 'timesignature_tests.test.ts');
        assert.ok(true, 'all pass');
    }));
    runTest('Big Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Additive Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
    ...
    runTest('Alternating Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
    ...
    runTest('Interchangeable Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
    ...
    runTest('Aggregate Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
        new Stave(10, 10, 300)
    ...
    runTest('Complex Signature Test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 400, 120);
        new Stave(10, 10, 300)
    ...
    runTest('Time Signature multiple staves alignment test', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Time Signature Change Test', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
