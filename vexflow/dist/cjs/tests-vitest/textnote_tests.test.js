...
describe('TextNote', () => {
    ...
    runTest('TextNote Formatting', (options) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        f.draw();
        yield expectMatchingScreenshot(options, 'textnote_tests.test.ts');
        assert.ok(true);
    }));
    runTest('TextNote Formatting 2', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('TextNote Superscript and Subscript', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        assert.equal(notes2[0].getText(), Flow.unicode.flat + 'I', 'TextNote.getText() return .text');
    ...
    runTest('TextNote Formatting With Glyphs 0', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 600, 230, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('TextNote Formatting With Glyphs 1', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 600, 230, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Crescendo', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 600, 230, options);
        const stave = f.Stave({ y: 40 });
        const score = f.EasyScore();
    ...
    runTest('Text Dynamics', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 600, 230, options);
        const score = f.EasyScore();
        const voice = score.voice([
