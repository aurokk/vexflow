...
describe('Rhythm', () => {
    ...
    runTest('Rhythm Draw - slash notes', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        yield expectMatchingScreenshot(options, 'rhythm_tests.test.ts');
        assert.ok(true);
    }));
    runTest('Rhythm Draw - beamed slash notes', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 150);
        // bar 1
    ...
    runTest('Rhythm Draw - beamed slash notes, some rests', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 150);
        // bar 1
        const staveBar1 = new Stave(10, 30, 300);
    ...
    runTest('Rhythm Draw - 16th note rhythm with scratches', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 150);
        // bar 1
        const staveBar1 = new Stave(10, 30, 300);
    ...
    runTest('Rhythm Draw - 32nd note rhythm with scratches', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const ctx = contextBuilder(options.elementId, 800, 150);
        // bar 1
        const staveBar1 = new Stave(10, 30, 300);
