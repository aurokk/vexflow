...
// MIT License
//
// Formatter Tests - Vitest Version
...
describe('Formatter', () => {
    ...
    runTest('Penultimate Note Padding', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        ...
        draw(2);
        draw(1);
        yield expectMatchingScreenshot(options, 'formatter_tests.test.ts');
        assert.ok(true);
    }));
    runTest('Whitespace and justify', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Notehead padding', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Justification and alignment with accidentals', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 600, 300, options);
        const score = f.EasyScore();
    ...
    runTest('Long measure taking full space', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const registry = new Registry();
        Registry.enableDefaultRegistry(registry);
    ...
    runTest('Vertical alignment - few unaligned beats', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Vertical alignment - many unaligned beats', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes1 = [
        ...
        voice2.addTickables(notes2);
        const formatter = new Formatter({ globalSoftmax: false });
    ...
    runTest('Vertical alignment - many unaligned beats (global softmax)', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const notes1 = [
            new StaveNote({ keys: ['b/4'], duration: '8r' }),
            new StaveNote({ keys: ['g/4'], duration: '16' }),
        ...
        const voice2 = new Voice({ num_beats: 4, beat_value: 4 });
        voice2.addTickables(notes2);
        const formatter = new Formatter({ globalSoftmax: true });
        formatter.joinVoices([voice1]);
        formatter.joinVoices([voice2]);
        const width = formatter.preCalculateMinTotalWidth([voice1, voice2]);
        formatter.format([voice1, voice2], width);
    ...
    runTest('Vertical alignment - many mixed elements', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('StaveNote - Justification', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Notes with Tab', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Multiple Staves - Justified', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Softmax', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Mixtime', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Tight', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
    ...
    runTest('Tight 2', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 440, 250, options);
        f.getContext().scale(0.8, 0.8);
        const score = f.EasyScore();
    ...
    runTest('Annotations', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const pageWidth = 916;
    ...
    runTest('Proportional Formatting - No Tuning', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const debug = true;
        ...
        const system = f.System({
            ...
            noJustification: !(undefined === undefined && true),
            formatIterations: 0,
    ...
    runTest('Proportional Formatting - No Justification', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const debug = true;
        Registry.enableDefaultRegistry(new Registry());
        const f = makeFactory(options.backend, options.elementId, 775, 750, options);
        const system = f.System({
            ...
            autoWidth: true,
            debugFormatter: debug,
            noJustification: !(false === undefined && true),
            formatIterations: 0,
            details: { alpha: undefined },
        });
        const score = f.EasyScore();
    ...
    runTest('Proportional Formatting (20 iterations)', (options) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const debug = true;
        Registry.enableDefaultRegistry(new Registry());
        const f = makeFactory(options.backend, options.elementId, 775, 750, options);
