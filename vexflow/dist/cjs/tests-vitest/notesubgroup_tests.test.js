...
describe('NoteSubGroup', () => {
    ...
    runTest('Basic - ClefNote, TimeSigNote and BarNote', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield expectMatchingScreenshot(options, 'notesubgroup_tests.test.ts');
    ...
    runTest('Multi Voice Multiple Draws', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
        const f = makeFactory(options.backend, options.elementId, 550, 200, options);
        const ctx = f.getContext();
        const stave = f.Stave().addClef('treble');
    ...
    runTest('Multi Staff', (options, contextBuilder) => __awaiter(void 0, void 0, void 0, function* () {
        const assert = createAssert();
