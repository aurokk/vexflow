...
class StaveNote extends StemmableNote {
    static get CATEGORY() {
        return "StaveNote" /* Category.StaveNote */;
    }
    /**
                ...
                if (noteU.isrest) {
                    ...
                    if (noteU.note.hasStem() && noteL.note.hasStem()) {
                        ...
                        !Tables.UNISON ||
                            ...
                            noteU.note.getModifiers().filter((item) => item.getCategory() === "Dot" /* Category.Dot */ && item.getIndex() === 0)
                                .length !==
                                noteL.note.getModifiers().filter((item) => item.getCategory() === "Dot" /* Category.Dot */ && item.getIndex() === 0)
                                    .length ||
