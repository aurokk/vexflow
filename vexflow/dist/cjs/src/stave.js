...
class Stave extends Element {
    ...
    static formatBegModifiers(staves) {
        ...
        // Align Clefs
        adjustCategoryStartX("Clef" /* Category.Clef */);
        // Align key signatures
        adjustCategoryStartX("KeySignature" /* Category.KeySignature */);
        // Align time signatures
        adjustCategoryStartX("TimeSignature" /* Category.TimeSignature */);
        let maxX = 0;
        // align note start
        staves.forEach((stave) => {
        ...
        // align REPEAT_BEGIN
        staves.forEach((stave) => {
            const modifiers = stave.getModifiers(StaveModifierPosition.BEGIN, "Barline" /* Category.Barline */);
            modifiers.forEach((modifier) => {
