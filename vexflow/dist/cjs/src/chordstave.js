...
export class ChordStave extends Element {
    static get CATEGORY() {
        return "ChordStave" /* Category.ChordStave */;
    }
    constructor(x, y, width, options) {
        ...
        const baseSpacing = (_a = options === null || options === void 0 ? void 0 : options.spacing_between_lines_px) !== null && _a !== void 0 ? _a : Tables.STAVE_LINE_DISTANCE;
        this.spacing_between_lines_px = baseSpacing * 1.5;
        this.space_above_staff_ln = (_b = options === null || options === void 0 ? void 0 : options.space_above_staff_ln) !== null && _b !== void 0 ? _b : 4;
    ...
    addTimeSignature(timeSpec) {
        ...
        timeSig.setStave(this); // Cast to any since TimeSignature expects Stave
     ...
     */
    addBarline(barline) {
        barline.setStave(this); // Cast to any since Barline expects Stave
