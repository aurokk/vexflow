 ...
 */
function checkStandard(assert: ReturnType<typeof createAssert>, tuning: Tuning): void {
 ...
 */
function checkStandardBanjo(assert: ReturnType<typeof createAssert>, tuning: Tuning): void {
  assert.throws(() => tuning.getValueForString(0), /BadArguments/, 'String 0');
