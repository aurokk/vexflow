...
describe('Fraction', () => {
  ...
  test('Basic', () => {
    ...
    assert.notEqual(f_1_2.greaterThan(1), true, 'Fraction: ! 1/2 > 1');
    ...
    assert.notEqual(f_1_2.greaterThanEquals(1), true, 'Fraction: ! 1/2 >= 1');

    assert.notEqual(f_1_2.lessThan(0.5), true, 'Fraction: ! 1/2 < 0.5');
    ...
    assert.notEqual(f_1_2.lessThanEquals(0.4), true, 'Fraction: ! 1/2 <= 0.4');
    ...
    assert.notEqual(tF_n, f_05, 'Fraction: tF_n != f_05');
    assert.propEqual(tF_n, f_05, 'tF_n deepEqual f_05');
    assert.notEqual(JSON.stringify(tF_n), JSON.stringify({}), 'tF_n notDeepEqual {}');
